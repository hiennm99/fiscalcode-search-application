...
import { Building2, ChevronDown, ChevronUp, Layers, User } from 'lucide-react';
...
export const EntityCard: React.FC<EntityCardProps> = ({ entities }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md hover:border-blue-200">
            {/* Main Card Content */}
            <div className="p-6 transition-colors duration-200 hover:bg-blue-50">
                <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4 flex-1">
                        ...
                        >
                                ...
                                >
                                    {formattedEntityInfo.is_company ? (
                                        <Building2 className="w-6 h-6 text-blue-600 transition-transform duration-200 group-hover:scale-110" />
                                    ) : (
                                        <User className="w-6 h-6 text-green-600 transition-transform duration-200 group-hover:scale-110" />
                                    )}
                                </div>

                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center space-x-3 mb-2 flex-wrap">
                                        <h3 className="text-lg font-semibold text-gray-900 truncate transition-colors duration-200 group-hover:text-blue-700">
